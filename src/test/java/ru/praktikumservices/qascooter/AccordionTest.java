...
public class AccordionTest {
    ...
    public AccordionTest(String idHeading, String idPanel, String text) {
        this.idHeading = idHeading;
        this.idPanel = idPanel;
        this.text = text; // Инициализируем поля класса в конструкторе
    }
    ...
    public void checkAccordion() {
        ...
        mainPage.clickAccordionHeadingButton(idHeading);
